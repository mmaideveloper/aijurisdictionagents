...
def baseline_snapshots() -> tuple[LawSnapshot, ...]:
    return (
        LawSnapshot(
            ...
            status="published",
            applicable_to="all construction permits",
        ...
        LawSnapshot(
            ...
            status="published",
            applicable_to="justice ministry notices",
...
def delta_snapshots() -> tuple[LawSnapshot, ...]:
    return (
        LawSnapshot(
            source_system="slov-lex",
            country_code="SK",
            ...
            status="published",
            applicable_to="all construction permits",
            superseded_by_url="https://www.slov-lex.sk/pravne-predpisy/SK/ZZ/2026/11/",
