...
| `DOCUMENT_PROCESSOR_MAX_RUNNING_TIME` | Optional max runtime per document-processor Azure run in minutes; `0` means unlimited |
...
| `DOCUMENT_PROCESSOR_MAX_RUNNING_TIME` | Optional max runtime per Azure job execution in minutes; `0` means unlimited |
...
| `LAWS_COLLECTOR_MAX_RUNNING_TIME` | Optional max runtime per laws collector Azure job execution in minutes; `0` means unlimited |
