"""Run one issue #720 local service with the approved encrypted E2E model route."""
...
def main() -> int:
    ...
    if not database_url or database_url == "unknown-variable":
        database_url = (
            "postgresql://postgres:postgres@127.0.0.1:5432/"
            "aij_e2e_720_primary_langgraph_orchestrator"
        )
    os.environ["DB_CLOUD"] = database_url
    os.environ["LAWS_DB_BACKEND"] = "postgres"
    os.environ["LAWS_DB_CLOUD"] = (
        "postgresql://postgres:postgres@127.0.0.1:5432/"
        "laws_e2e_720_primary_langgraph_orchestrator"
    )
