...
- Email scheduler ACA Job (`AZURE_EMAIL_SCHEDULER_JOB_NAME`, default `email-scheduler`; `infra_deploy` creates a no-op shell until the dedicated email deploy publishes the real image)
