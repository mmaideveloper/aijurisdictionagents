...
- The prefetch helper runs directly from the checked-out repo source on the GitHub runner, so it does not require a separate `pip install -e .` step before deployment.
