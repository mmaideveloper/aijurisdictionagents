...
- `DB_OPTION=azure`
- `DB_CLOUD=postgresql://<admin>:<password>@<server>.postgres.database.azure.com:5432/<database>?sslmode=require`

Azure Database for PostgreSQL Flexible Server uses the configured administrator
login as-is in the connection string username.
