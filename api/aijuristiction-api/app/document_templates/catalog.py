...
def build_default_document_templates() -> list[DocumentTemplateDefinition]:
    return _merge_template_seeds(
        ...
        DocumentTemplateDefinition(
            ...
            description="Vysokorizikovy pracovny navrh; pred podpisom vyzaduje pravnu kontrolu.",
            source_format="WEB",
            source_url="https://www.slov-lex.sk/pravne-predpisy/SK/ZZ/1991/513/",
            source_profile="official_legislation_with_internal_draft",
            source_review_status="classified_pending_legal_review",
            normalization_notes="Neexistuje licencovany stylovy vzor. Telo sa nesmie doplnit kopirovanim tretiej strany bez opravnenia.",
            legal_basis_refs=("https://www.slov-lex.sk/pravne-predpisy/SK/ZZ/1991/513/",),
            risk_tier="high",
            required_preflight_facts=("principal_identification", "agent_identification", "contract_scope", "territory", "commission_terms", "authority_to_conclude", "duration_and_termination"),
            ...
            source_refs=(
                TemplateSourceReference(
                    ...
                    notes="Pravny zaklad; nie je to stylovy vzor ani hotovy dokument na podpis.",
                ),
            ),
            is_enabled=True,
            is_deleted=False,
        ...
        DocumentTemplateDefinition(
            ...
            description="Vysokorizikovy pracovny navrh a kontrolny zoznam pre zmenu v obchodnom registri.",
            source_format="WEB",
            source_url="https://www.slov-lex.sk/pravne-predpisy/SK/ZZ/1991/513/",
            source_profile="official_legislation_and_submission",
            source_review_status="classified_pending_legal_review",
            normalization_notes="Vyžaduje kontrolu spoločenskej zmluvy, obmedzení prevodu a schválenia pred podpisom.",
            legal_basis_refs=("https://www.slov-lex.sk/pravne-predpisy/SK/ZZ/1991/513/",),
            risk_tier="high",
            required_preflight_facts=("company_identifier", "current_articles_reviewed", "transferor_identification", "transferee_identification", "share_scope", "transfer_price", "transfer_restrictions_checked", "general_meeting_consent", "insolvency_and_enforcement_check", "signature_certification_plan"),
            human_review_required=True,
            submission_mode="human_review_draft",
            body=(
            ...
            source_refs=(
                TemplateSourceReference(
                    ...
                    publisher="Slov-Lex",
                    source_kind="legal_basis",
                    notes="Pravny zaklad pre zmluvu o prevode obchodneho podielu.",
                ),
                TemplateSourceReference(
                    label="Navrh na zmenu zapisu v obchodnom registri",
                    url="https://sluzby.orsr.sk/Sluzby/Zmena",
                    publisher="Obchodny register SR",
                    source_kind="official_submission",
                    notes="Oficialny elektronicky sposob podania; nie je vzorom zmluvy.",
                ),
            ),
            is_enabled=True,
            is_deleted=False,
        ...
        DocumentTemplateDefinition(
            ...
            description="Vysokorizikovy pracovny navrh; rozlisuje viacspolocnicku zmluvu a zakladatelsku listinu.",
            source_format="WEB",
            source_url="https://www.slov-lex.sk/pravne-predpisy/SK/ZZ/1991/513/",
            source_profile="official_legislation_and_submission",
            source_review_status="classified_pending_legal_review",
            normalization_notes="Pred pouzitim potvrďte pocet zakladatelov a vykonajte individualnu pravnu kontrolu.",
            legal_basis_refs=("https://www.slov-lex.sk/pravne-predpisy/SK/ZZ/1991/513/",),
            risk_tier="high",
            required_preflight_facts=("founder_count", "company_name", "company_seat", "business_activities", "shareholders", "registered_capital", "contributions", "managing_directors", "registry_filing_plan"),
            human_review_required=True,
            submission_mode="human_review_draft",
            body=(
            ...
            source_refs=(
                TemplateSourceReference(
                    ...
                    publisher="Slov-Lex",
                    source_kind="legal_basis",
                    notes="Pravny zaklad; nie je stylovym vzorom ani oficialnym podanim.",
                ),
                TemplateSourceReference(
                    label="Prvozapis spolocnosti do obchodneho registra",
                    url="https://sluzby.orsr.sk/Sluzby/Zapis",
                    publisher="Obchodny register SR",
                    source_kind="official_submission",
                    notes="Oficialny elektronicky sposob podania; nie je vzorom spolocenskej zmluvy.",
                ),
            ),
            is_enabled=True,
            is_deleted=False,
        ...
        DocumentTemplateDefinition(
            ...
            description="Oficialny formularovy podklad; JurisDigta nevytvara podanie pripravene na odoslanie.",
            source_format="PDF",
            source_url="https://www.justice.gov.sk/dokumenty/2021/06/vyzivne_pre_malolete_dieta.pdf",
            source_profile="official_governed_form",
            source_review_status="reviewed_metadata_only",
            normalization_notes="Pouzite aktualny oficialny formular a individualnu pravnu kontrolu pred podanim.",
            risk_tier="high",
            required_preflight_facts=("applicant_identification", "respondent_identification", "child_identification", "court_jurisdiction", "requested_amount", "supporting_evidence"),
            human_review_required=True,
            ...
            source_refs=(
                TemplateSourceReference(
                    label="Vyzivne pre malolete dieta",
                    url="https://www.justice.gov.sk/dokumenty/2021/06/vyzivne_pre_malolete_dieta.pdf",
                    publisher="Ministerstvo spravodlivosti SR",
                    source_kind="official_submission",
                    notes="Oficialny formular; nie je nahradzany generovanym podanim.",
                ),
            ),
            is_enabled=True,
            is_deleted=False,
        ...
        DocumentTemplateDefinition(
            ...
            description="Oficialny formularovy podklad; JurisDigta nevytvara podanie pripravene na odoslanie.",
            source_format="RTF",
            source_url="https://www.justice.gov.sk/dokumenty/2021/06/Platobny-rozkaz_jeden-zalovany-1.rtf",
            source_profile="official_governed_form",
            source_review_status="reviewed_metadata_only",
            normalization_notes="Pouzite aktualny oficialny formular alebo elektronicku sluzbu a pravnu kontrolu pred podanim.",
            risk_tier="high",
            required_preflight_facts=("claimant_identification", "defendant_identification", "court_jurisdiction", "claim_amount", "claim_due_date", "supporting_evidence", "official_filing_route"),
            human_review_required=True,
            submission_mode="official_form_only",
            body="",
            ...
            source_refs=(
                TemplateSourceReference(
                    label="Platobny rozkaz jeden zalovany",
                    url="https://www.justice.gov.sk/dokumenty/2021/06/Platobny-rozkaz_jeden-zalovany-1.rtf",
                    publisher="Ministerstvo spravodlivosti SR",
                    source_kind="official_submission",
                    notes="Oficialny formular; nie je nahradzany generovanym podanim.",
                ),
        ...
        DocumentTemplateDefinition(
            ...
            template_kind="court_filing",
            description="Vysokorizikovy pracovny navrh pre pravnu kontrolu, nie podanie pripravene na odoslanie.",
            source_format="WEB",
            source_url="https://www.slov-lex.sk/pravne-predpisy/SK/ZZ/2015/160/",
            source_profile="court_draft_human_review",
            source_review_status="classified_pending_legal_review",
            normalization_notes="Neexistuje univerzalny oficialny formular pre vsetky zaloby; nikdy ho neoznacujte ako pripravene na podanie.",
            legal_basis_refs=("https://www.slov-lex.sk/pravne-predpisy/SK/ZZ/2015/160/",),
            risk_tier="high",
            required_preflight_facts=("claimant_identification", "defendant_identification", "court_jurisdiction", "claim_request", "facts", "supporting_evidence", "limitation_period_review"),
            human_review_required=True,
            submission_mode="human_review_draft",
            body="",
            ...
            source_refs=(
                TemplateSourceReference(
                    label="Civilny sporovy poriadok",
                    url="https://www.slov-lex.sk/pravne-predpisy/SK/ZZ/2015/160/",
                    publisher="Slov-Lex",
                    source_kind="legal_basis",
                    notes="Pravny zaklad; nie je univerzalnym oficialnym formularom pre zalobu.",
                ),
            ),
            is_enabled=True,
            is_deleted=False,
